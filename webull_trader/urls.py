...
urlpatterns = [
    ...
    path('day-reports/regvol', views.day_reports_regvol, name='day_reports_regvol'),
    path('day-reports/bmovol', views.day_reports_bmovol, name='day_reports_bmovol'),
    path('day-reports/amcvol', views.day_reports_amcvol, name='day_reports_amcvol'),

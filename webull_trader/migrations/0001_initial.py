# Generated by Django 3.1.7 on 2021-05-13 20:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algo_type', models.PositiveSmallIntegerField(choices=[(0, '[Default] Trade as much as possible, mainly for collect data.'), (1, '[Dynamic Optimize] Trade based on win rate, reduce size if win rate is low.')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setup', models.PositiveSmallIntegerField(choices=[(0, '[Day] First candle new high'), (1, '[Day] Gap and Go'), (2, '[Day] Bull Flag'), (3, '[Day] Reversal'), (4, '[Swing] 20 days new high')], default=0)),
            ],
        ),
    ]

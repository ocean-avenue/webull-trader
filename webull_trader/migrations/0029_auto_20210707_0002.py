# Generated by Django 3.1.7 on 2021-07-07 04:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('webull_trader', '0028_auto_20210703_1717'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='setup',
            field=models.PositiveSmallIntegerField(choices=[(0, '[Day] First candle new high'), (1, '[Day] Gap and Go'), (2, '[Day] Bull Flag'), (3, '[Day] Reversal'), (4, '[Day] Red to Green'), (8, '[Day] 10 candles new high'), (5, '[Day] 20 candles new high'), (6, '[Day] 30 candles new high'), (7, '[Day] Earning Gap'), (9, '[Day] VWAP Reclaim'), (100, '[Swing] 20 days new high'), (101, '[Swing] 55 days new high'), (500, '[Error] Failed to sell'), (999, 'Unknown')], default=999),
        ),
        migrations.AlterField(
            model_name='webullordernote',
            name='setup',
            field=models.PositiveSmallIntegerField(choices=[(0, '[Day] First candle new high'), (1, '[Day] Gap and Go'), (2, '[Day] Bull Flag'), (3, '[Day] Reversal'), (4, '[Day] Red to Green'), (8, '[Day] 10 candles new high'), (5, '[Day] 20 candles new high'), (6, '[Day] 30 candles new high'), (7, '[Day] Earning Gap'), (9, '[Day] VWAP Reclaim'), (100, '[Swing] 20 days new high'), (101, '[Swing] 55 days new high'), (500, '[Error] Failed to sell'), (999, 'Unknown')], default=0),
        ),
    ]

# Generated by Django 3.1.7 on 2021-06-09 02:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('webull_trader', '0018_auto_20210605_0043'),
    ]

    operations = [
        migrations.AddField(
            model_name='tradingsettings',
            name='extended_order_amount_limit',
        ...
        migrations.AlterField(
            ...
            name='setup',
            field=models.PositiveSmallIntegerField(choices=[(0, '[Day] First candle new high'), (1, '[Day] Gap and Go'), (2, '[Day] Bull Flag'), (3, '[Day] Reversal'), (4, '[Day] Red to Green'), (8, '[Day] 10 minutes new high'), (5, '[Day] 20 minutes new high'), (6, '[Day] 30 minutes new high'), (7, '[Day] Earning Gap'), (100, '[Swing] 20 days new high'), (101, '[Swing] 55 days new high'), (999, 'Unknown')], default=100),
        ),
        migrations.AlterField(
